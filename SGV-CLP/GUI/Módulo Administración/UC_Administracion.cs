...
namespace SGV_CLP.GUI
{
    public partial class UC_Administracion : UserControl
    {
        ...
        private void txtAniadirNombreUsuario_TextChanged(object sender, EventArgs e)
        {
            //USERNAME
        ...
        private void txtAniadirNombre1Usuario_TextChanged(object sender, EventArgs e)
        {
            if (txtAniadirNombre1Usuario.Text.Length > 0 && control_nombre1)
            {
                control_nombre1 = false;
                count_correct_fields++;
            }
            else if (txtAniadirNombre1Usuario.Text.Length == 0 && !control_nombre1)
            {
        ...
        private void txtAniadirApellido2Usuario_TextChanged(object sender, EventArgs e)
        {
            validateFieldsCounter_Usuario();
        }
