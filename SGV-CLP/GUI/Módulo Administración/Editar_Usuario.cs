...
namespace SGV_CLP.GUI.Módulo_Administración
{
    public partial class Editar_Usuario : Form
    {
        ...
        public Editar_Usuario(string cc_Usuario)
        {
            ...
            txt_EditarNombre2.MaxLength = max_long_nombres;
            txt_EditarApell1.MaxLength = max_long_apellidos;
            txt_EditarApell2.MaxLength = max_long_apellidos;
        ...
        public void llenarCampos()
        {
            ...
            this.txt_EditarNombre2.Text = UsuarioMapper.ConsultarAtributoUsuario(cc_Usuario, "segundo_Nombre");
            this.txt_EditarApell1.Text = UsuarioMapper.ConsultarAtributoUsuario(cc_Usuario, "primer_Apellido");
            this.txt_EditarApell2.Text = UsuarioMapper.ConsultarAtributoUsuario(cc_Usuario, "segundo_Apellido");
        ...
        private void SBAceptar_Click(object sender, EventArgs e)
        {
            UsuarioMapper.EditarUsuario(this.cc_Usuario, this.txt_editarUsername.Text, this.txt_EditarPassword.Text, this.txt_EditarNombre1.Text,
                this.txt_EditarNombre2.Text, this.txt_EditarApell1.Text, this.txt_EditarApell2.Text, this.cBox_EditarCargo.SelectedItem.ToString());
        ...
        private void txt_EditarNombre2_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsLetter(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txt_EditarNombre2_TextChanged(object sender, EventArgs e)
        {
            validateFieldsCounter_Usuario();
        }
        ...
        private void txt_EditarApell2_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsLetter(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void txt_EditarApell2_TextChanged(object sender, EventArgs e)
        {
            validateFieldsCounter_Usuario();
        }

        private void cBox_EditarCargo_SelectedIndexChanged(object sender, EventArgs e)
        {
            // NO SE USA
        }
