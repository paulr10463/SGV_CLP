...
namespace SGV_CLP.Classes.Customers_Module
{
    public class Customer
    {
        ...
        public Customer(string customerID, string firstName, string MiddleName, string firstLastName, string secondLastName, string homeAddress, string phoneNumber, string eMail)
        {
