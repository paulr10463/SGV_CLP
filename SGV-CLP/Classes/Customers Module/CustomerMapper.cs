    ...
    public class CustomerMapper
    {
        ...
        public static void AddCustomer(Customer customer)
        {
            ...
            using (var cmd = new NpgsqlCommand("INSERT INTO public.\"Cliente\"(\"cc_Cliente\", \"primer_Nombre\", \"segundo_Nombre\", \"primer_Apellido\", \"segundo_Apellido\", \"direccion_Domicilio\", telefono, \"correo_Electronico\") VALUES (@CC_Cliente, @Primer_Nombre, @Segundo_Nombre, @Primer_Apellido, @Segundo_Apellido, @Direccion_Domicilio, @Telefono, @Correo_Electronico)", connection))
            {
                ...
                cmd.Parameters.AddWithValue("@Segundo_Nombre", customer.MiddleName);
                cmd.Parameters.AddWithValue("@Primer_Apellido", customer.firstLastName);
                cmd.Parameters.AddWithValue("@Segundo_Apellido", customer.secondLastName);
        ...
        public static async Task<bool> UpdateCustomer(Customer customer)
        {
            ...
            if (customer.customerID != null)
            {
                ...
                command.Parameters.AddWithValue("@Segundo_Nombre", customer.MiddleName);
                command.Parameters.AddWithValue("@Primer_Apellido", customer.firstLastName);
                command.Parameters.AddWithValue("@Segundo_Apellido", customer.secondLastName);
