...
namespace SGV_CLP.Classes
{
    ...
    {
        private static readonly string _connectionString = "Host=localhost:5432;Username=postgres;Password=root;Database=SGV-CLP";
        //USAR using SGV_CLP.Classes
        //--------
        //CREATE
        public static async Task<string> IngresarCliente(Cliente cliente)
        {
            ...
            command.CommandText = "INSERT INTO public.\"Cliente\"(\"cc_Cliente\", \"primer_Nombre\", \"segundo_Nombre\", \"primer_Apellido\", \"segundo_Apellido\", \"direccion_Domicilio\", telefono, \"correo_Electronico\") VALUES (@CC_Cliente, @Primer_Nombre, @Segundo_Nombre, @Primer_Apellido, @Segundo_Apellido, @Direccion_Domicilio, @Telefono, @Correo_Electronico);";
            ...
            cliente.Cc_Cliente = (string)await command.ExecuteScalarAsync();
            return cliente.Cc_Cliente;
        }
